...
if(isset($_GET['patient_id'])){
    ...
    if(mysql_num_rows($result) > 0){
        ...
        $max_visit_id = $admin->getMaxVisitId($chamber_name, $doc_name);
        ...
        mysql_query("insert into visit (VISIT_ID, patient_id,VISIT_DATE,chamber_id, created_by_user_id, doc_id ) 
            values( '".$max_visit_id."', '".$patient_id."', NOW(),'".$chamber_name."','".$user_name."','".$doc_name."' )") or die(mysql_error());
    ...
    echo "You are authorize to perform this operation";
}
?>
